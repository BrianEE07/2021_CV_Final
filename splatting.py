...
# 	cv2.imwrite('summation.jpg', tenSummation[0, :, :, :].cpu().numpy().transpose(1, 2, 0))
# 	cv2.imwrite('average.jpg', tenAverage[0, :, :, :].cpu().numpy().transpose(1, 2, 0))
# 	cv2.imwrite('linear.jpg', tenLinear[0, :, :, :].cpu().numpy().transpose(1, 2, 0))
# 	cv2.imwrite('softmax.jpg', tenSoftmax[0, :, :, :].cpu().numpy().transpose(1, 2, 0))
	# cv2.waitKey(delay=0)
# end